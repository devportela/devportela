...
🎓 Estudante do curso de Desenvolvimento de Sistemas, apaixonado por tecnologia e em busca de me tornar um Desenvolvedor!
...
![Tech Stack](https://skillicons.dev/icons?i=html,css,tailwind,bootstrap,js,mysql,php,python,nodejs,java,idea,git)
